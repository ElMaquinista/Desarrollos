...
function http_ping() {
    ...
    document.getElementById('result').innerHTML = " Haciendo ping a " + fqdn + " con 32 bytes de datos: <br>";
            ...
            ping.onreadystatechange = function () {
                ...
                if (ping.readyState == 4 && TIMEOUT_ERROR == 0) {
                    ...
                    if (ping.seq > 1) {
                        ...
                        document.getElementById('result').innerHTML += " Respuesta desde " + fqdn + "  bytes=32 secuencia_http=" + (ping.seq - 1) + " tiempo=" + delta_time + " ms <br>";
                    }
                }
            }
...
// funccion de hacer ping 
function hacer_ping(url_ip) {
    if (url_ip) {
        var fqdn = url_ip;
        var NB_ITERATIONS = 4; // numero de loops
        var MAX_ITERATIONS = 5; // XMLHttpRequest esta limitado según el navegador
        ...
        console.log(" Haciendo ping a " + fqdn + " con 32 bytes de datos:");
        ...
        var ping_loop = setInterval(function () {
                ...
                ping.onreadystatechange = function () {
                    ...
                    if (ping.readyState == 4 && TIMEOUT_ERROR == 0) {
                        ...
                        if (ping.seq > 1) {
                            ...
                            time_cumul += delta_time;
                            // document.getElementById('result').innerHTML += " Respuesta desde " + fqdn + "  bytes=32 secuencia_http=" + (ping.seq - 1) + " tiempo=" + delta_time + " ms <br>";
                            console.log("Respuesta desde " + fqdn + "  bytes=32 secuencia_http=" + (ping.seq - 1) + " tiempo=" + delta_time + " ms");
                        }
                    }
                }
            ...
            if ((i > NB_ITERATIONS) && (over_flag < 1)) {
                ...
                console.log("Estadísticas de ping para " + fqdn + ":    Paquetes: enviados = " + (i - 1) + ", recibidos = " + (i - 1) + ", perdidos = 0 Tiempo aproximado de ida y vuelta en milisegundos: " + avg_time + "ms");
            ...
            if (TIMEOUT_ERROR == 1) {
                ...
                console.log("Respuesta desde " + fqdn + ": Host de destino inaccesible.");
