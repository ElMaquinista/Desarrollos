...
const habitah_modal_audio_salida = (() => {
    ...
    async function lanzar_modal_audio_salida() {
        ...
        let data = {
            id: "modal_efimero_bs5",
            titulo: "Selecciona el Dispositivo de salida",
            nodo_cuerpo: nodo_contenedor,
            className: "modal_audio_salida modal_efimero_bs5",
        };
    ...
    async function crear_nodo_audio_salida() {
        ...
        nodo_select.className = " seleccion_audio_salida form-select";
    ...
    return {
        lanzar_modal_audio_salida,
        crear_nodo_audio_salida,
        get_audio_output,
        seleccionar_audio_output
    };
})();
